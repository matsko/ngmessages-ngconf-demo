/**
 * @license AngularJS v1.4.0-local+sha.0c541cf
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message += '\nhttp://errors.angularjs.org/1.4.0-local+sha.0c541cf/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.4.0-local+sha.0c541cf',    // all of these placeholder strings will be replaced by grunt's
